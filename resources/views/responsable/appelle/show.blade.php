     ...
     <div
          ...
          <div class="p-5">
               ...
               <div class="grid grid-cols-1 gap-2">
                    <h2
                         class="mb-4 mt-8 mx-auto text-xl font-bold text-gray-900 dark:text-white md:text-xl lg:text-xl ">
                    ...
                    <div>
                         <p class="text-gray-500 text-sm mt-2 dark:text-white">{!! $appelle->description !!}</p>
                    </div>
               </div>
