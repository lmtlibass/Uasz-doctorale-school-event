<nav class="fixed w-full z-10 border-[#fff] bg-[#fff] dark:bg-gray-800 dark:border-gray-700 shadow-md">
     <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-10 p-5">
