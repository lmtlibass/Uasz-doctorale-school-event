...
<body class="antialiased">
     ...
     <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="py-4">
               <h1 class="text-2xl">Sallon de cinférence</h1>
          </div>


          <div class="max-w-2xl">
               <video id="localVideo" class="w-full" autoplay muted">
               </video>
               ...
               <div class="flex space-x-2">
                    ...
                    <label for="">
                         Camera:
                         <select name="" id="cameraSelectBox">
                    ...
                    <button id="joinMeetingBtn" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-offset-2 focus:ring-indigo-500">
                         Rejoindre un sallon
                    </button>
               </div>
