...
async function initializeView() {
    ...
    jquery("#waitingAreaToggleMicrophone").on("click", function () {
        if (micOn) {
            micOn = false;
            jquery("#waitingAreaToggleMicrophone").removeClass("bg-green-500");
            jquery("#waitingAreaToggleMicrophone").addClass("bg-green-300");
        } else {
            micOn = true;
            jquery("#waitingAreaToggleMicrophone").removeClass("bg-green-300");
            jquery("#waitingAreaToggleMicrophone").addClass("bg-green-500");
        }
    });
    ...
    jquery("#waitingAreaToggleCamera").on("click", async function () {
        if (cameraOn) {
            cameraOn = false;
            jquery("#waitingAreaToggleCamera").removeClass("bg-green-500");
            jquery("#waitingAreaToggleCamera").addClass("bg-green-300");
            ...
            cameraOn = true;
            jquery("#waitingAreaToggleCamera").removeClass("bg-green-300");
            jquery("#waitingAreaToggleCamera").addClass("bg-green-500");
...
jquery("#joinMeetingBtn").on("click", async function () {
    ...
    try {
        ...
        if (cameraOn) {
            ...
            jquery("#toggleCamera").removeClass("bg-green-300");
            jquery("#toggleCamera").addClass("bg-green-500");
        }
         ...
         */
        if (micOn) {
            jquery("#toggleMicrophone").removeClass("bg-green-300");
...
meeting.on("remoteTrackStarted", function (remoteTrackItem) {
    ...
    if (remoteTrackItem.type === "video") {
        ...
        if (jquery("#video-" + remoteTrackItem.participantSessionId)[0]) {
            jquery(
                "#video-" + remoteTrackItem.participantSessionId
    ...
    if (remoteTrackItem.type === "audio") {
        ...
        if (jquery("#video-" + remoteTrackItem.participantSessionId)[0]) {
            jquery(
                "#audio-" + remoteTrackItem.participantSessionId
            )[0].srcObject = mediaStream;
...
jquery("#toggleMicrophone").on("click", async function () {
    if (micOn) {
        ...
        jquery("#toggleMicrophone").addClass("bg-green-300");
        micOn = false;
...
jquery("#toggleCamera").on("click", async function () {
    if (cameraOn) {
        ...
        jquery("#toggleCamera").addClass("bg-green-300");
        jquery("#toggleScreen").removeClass("bg-green-500");
        jquery("#toggleScreen").addClass("bg-green-300");
        cameraOn = false;
...
jquery("#toggleScreen").on("click", async function () {
    if (screenSharingOn) {
        ...
        jquery("#toggleScreen").removeClass("bg-green-300");
